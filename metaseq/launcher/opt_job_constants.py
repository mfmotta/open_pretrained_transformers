...
MODEL_SIZES = {
    "8m": Size(4, 128, 2, 64, int(4 * 2048), 1.0e-3, 2),  # tiny #MMchanged batch size
    "8m_mp1": Size(4, 128, 2, 64, int(0.125 * M), 1.0e-3, 1),  # tiny with 1 mp
<<<<<<< HEAD
    "125m": Size(12, 768, 12, 64, int(0.005 * M), 6.0e-4, 2),  # small
=======
    "8m": Size(4, 128, 2, 64, int(4 * 2048), 1.0e-3, 2),  # tiny #MMchanged batch size
    "125m": Size(12, 768, 12, 64, int(4 * 2048), 6.0e-4, 2),  # small
>>>>>>> 2952617... changed batch sizes
